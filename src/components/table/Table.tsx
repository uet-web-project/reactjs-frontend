  ...
  return (
    <div className="TableContainer">
      <div className="firstPart">
        <button className="normalBut">filter</button>
        <input className="generalInput" type="text" />
        <button className="normalBut" id="manageColumn">Manage Column</button>
      </div>
      <Paper className="secondPart"
        sx={{
          overflow: "hidden",
